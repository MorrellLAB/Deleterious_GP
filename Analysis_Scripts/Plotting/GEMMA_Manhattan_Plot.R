...
plot(0, type="n", axes=FALSE, ylim=c(0, 8), xlim=c(0, 4600), xlab="", ylab="-log10(P)", main="Yield (kg/ha)")
sapply(
    seq_along(chroms),
    function(x) {
        cname <- chroms[x]
...
# Make a plot for DON
plot(0, type="n", axes=FALSE, ylim=c(0, 8), xlim=c(0, 4600), xlab="", ylab="-log10(P)", main="DON (ppm)")
sapply(
    seq_along(chroms),
    function(x) {
        cname <- chroms[x]
...
plot(0, type="n", axes=FALSE, ylim=c(0, 8), xlim=c(0, 4600), xlab="", ylab="-log10(P)", main="Height (cm)")
sapply(
    seq_along(chroms),
    function(x) {
        cname <- chroms[x]
