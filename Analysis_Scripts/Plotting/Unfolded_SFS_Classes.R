...
freqs <- read.table("/Volumes/DataDisk/Dropbox/GitHub/Deleterious_GP/Results/Genotype_Freqs/DAF_By_Cycle.txt", header=TRUE)
nonc <- as.character(read.table("/Volumes/DataDisk/Dropbox/GitHub/Deleterious_GP/Results/SNP_Annotations/GP_Noncoding.txt", header=FALSE)$V1)
syn <- as.character(read.table("/Volumes/DataDisk/Dropbox/GitHub/Deleterious_GP/Results/SNP_Annotations/GP_Synonymous.txt", header=FALSE)$V1)
nonsyn <- as.character(read.table("/Volumes/DataDisk/Dropbox/GitHub/Deleterious_GP/Results/SNP_Annotations/GP_Nonsynonymous.txt", header=FALSE)$V1)
del <- as.character(read.table("/Volumes/DataDisk/Dropbox/GitHub/Deleterious_GP/Results/SNP_Annotations/GP_Deleterious.txt", header=FALSE)$V1)
