...
yld <- read.table("/Users/tomkono/Dropbox/GitHub/Deleterious_GP/Results/GEMMA/Yield_BOPA_LMM.assoc.txt.gz", header=TRUE)
don <- read.table("/Users/tomkono/Dropbox/GitHub/Deleterious_GP/Results/GEMMA/DON_BOPA_LMM.assoc.txt.gz", header=TRUE)
hgt <- read.table("/Users/tomkono/Dropbox/GitHub/Deleterious_GP/Results/GEMMA/Height_BOPA_LMM.assoc.txt.gz", header=TRUE)
...
png(file="GEMMA_BOPA_Manhattan.png", res=150, height=600, width=1200)
